...
class emotionalMotor : public RoboComp::Application
{
public:
	emotionalMotor (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::emotionalMotor::initialize()
{
...
int ::emotionalMotor::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::emotionalMotor app(prefix, startup_check_flag);
